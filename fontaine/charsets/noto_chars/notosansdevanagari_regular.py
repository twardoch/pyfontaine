class Charset:
    ...
    def glyphs(self):
        ...
        chars.append(
            0x1CD7
        )  # uni1CD7	VEDIC TONE YAJURVEDIC KATHAKA INDEPENDENT SVARITA
        ...
        chars.append(
            0x1CD5
        )  # uni1CD5	VEDIC TONE YAJURVEDIC AGGRAVATED INDEPENDENT SVARITA
        ...
        chars.append(
            0x1CD9
        )  # uni1CD9	VEDIC TONE YAJURVEDIC KATHAKA INDEPENDENT SVARITA SCHROEDER
        ...
        chars.append(
            0x1CE0
        )  # uni1CE0	VEDIC TONE RIGVEDIC KASHMIRI INDEPENDENT SVARITA
