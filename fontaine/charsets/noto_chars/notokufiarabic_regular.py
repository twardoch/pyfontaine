class Charset:
    ...
    def glyphs(self):
        ...
        chars.append(
            0xFEF5
        )  # uni06440622.isol	ARABIC LIGATURE LAM WITH ALEF WITH MADDA ABOVE ISOLATED FORM
        chars.append(
            0xFEF6
        )  # uni06440622.fina	ARABIC LIGATURE LAM WITH ALEF WITH MADDA ABOVE FINAL FORM
        chars.append(
            0xFEF7
        )  # uni06440623.isol	ARABIC LIGATURE LAM WITH ALEF WITH HAMZA ABOVE ISOLATED FORM
        chars.append(0xFE76)  # fatha_01	ARABIC FATHA ISOLATED FORM
        chars.append(
            0xFEF8
        )  # uni06440623.fina	ARABIC LIGATURE LAM WITH ALEF WITH HAMZA ABOVE FINAL FORM
        chars.append(
            0xFEF9
        )  # uni06440625.isol	ARABIC LIGATURE LAM WITH ALEF WITH HAMZA BELOW ISOLATED FORM
        chars.append(
            0xFEFA
        )  # uni06440625.fina	ARABIC LIGATURE LAM WITH ALEF WITH HAMZA BELOW FINAL FORM
        chars.append(
            0xFEFB
        )  # uni06440627.isol	ARABIC LIGATURE LAM WITH ALEF ISOLATED FORM
        chars.append(
            0xFEFC
        )  # uni06440627.fina	ARABIC LIGATURE LAM WITH ALEF FINAL FORM
        ...
        chars.append(
            0xFBA5
        )  # uni06C0.fina	ARABIC LETTER HEH WITH YEH ABOVE FINAL FORM
        ...
        chars.append(
            0xFBAC
        )  # uni06BE.init	ARABIC LETTER HEH DOACHASHMEE INITIAL FORM
        chars.append(
            0xFBAD
        )  # uni06BE.medi	ARABIC LETTER HEH DOACHASHMEE MEDIAL FORM
        ...
        chars.append(
            0xFBB1
        )  # uni06D3.fina	ARABIC LETTER YEH BARREE WITH HAMZA ABOVE FINAL FORM
        ...
        chars.append(
            0xFBE8
        )  # uni0649.init	ARABIC LETTER UIGHUR KAZAKH KIRGHIZ ALEF MAKSURA INITIAL FORM
        chars.append(
            0xFBE9
        )  # uni0649.medi	ARABIC LETTER UIGHUR KAZAKH KIRGHIZ ALEF MAKSURA MEDIAL FORM
        ...
        chars.append(
            0xFC5E
        )  # uni0651064C	ARABIC LIGATURE SHADDA WITH DAMMATAN ISOLATED FORM
        chars.append(
            0xFC5F
        )  # uni0651064D	ARABIC LIGATURE SHADDA WITH KASRATAN ISOLATED FORM
        chars.append(
            0xFC60
        )  # uni0651064E	ARABIC LIGATURE SHADDA WITH FATHA ISOLATED FORM
        chars.append(
            0xFC61
        )  # uni0651064F	ARABIC LIGATURE SHADDA WITH DAMMA ISOLATED FORM
        chars.append(
            0xFC62
        )  # uni06510650	ARABIC LIGATURE SHADDA WITH KASRA ISOLATED FORM
        chars.append(
            0xFC63
        ...
        chars.append(
            0xFE81
        )  # uni0622	ARABIC LETTER ALEF WITH MADDA ABOVE ISOLATED FORM
        chars.append(
            0xFE82
        )  # uni0622.fina	ARABIC LETTER ALEF WITH MADDA ABOVE FINAL FORM
        chars.append(
            0xFE83
        )  # uni0623	ARABIC LETTER ALEF WITH HAMZA ABOVE ISOLATED FORM
        chars.append(
            0xFE84
        )  # uni0623.fina	ARABIC LETTER ALEF WITH HAMZA ABOVE FINAL FORM
        chars.append(
            0xFE85
        )  # uni0624	ARABIC LETTER WAW WITH HAMZA ABOVE ISOLATED FORM
        chars.append(
            0xFE86
        )  # uni0624.fina	ARABIC LETTER WAW WITH HAMZA ABOVE FINAL FORM
        chars.append(
            0xFE87
        )  # uni0625	ARABIC LETTER ALEF WITH HAMZA BELOW ISOLATED FORM
        chars.append(
            0xFE88
        )  # uni0625.fina	ARABIC LETTER ALEF WITH HAMZA BELOW FINAL FORM
        chars.append(
            0xFE89
        )  # uni0626	ARABIC LETTER YEH WITH HAMZA ABOVE ISOLATED FORM
        chars.append(
            0xFE8A
        )  # uni0626.fina	ARABIC LETTER YEH WITH HAMZA ABOVE FINAL FORM
        chars.append(
            0xFE8B
        )  # uni0626.init	ARABIC LETTER YEH WITH HAMZA ABOVE INITIAL FORM
        chars.append(
            0xFE8C
        )  # uni0626.medi	ARABIC LETTER YEH WITH HAMZA ABOVE MEDIAL FORM
