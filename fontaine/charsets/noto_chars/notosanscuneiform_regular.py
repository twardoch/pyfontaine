class Charset:
    ...
    def glyphs(self):
        ...
        chars.append(
            0x12030
        )  # glyph00052	CUNEIFORM SIGN AN PLUS NAGA OPPOSING AN PLUS NAGA
        ...
        chars.append(
            0x1203B
        )  # glyph00063	CUNEIFORM SIGN ASH OVER ASH TUG2 OVER TUG2 TUG2 OVER TUG2 PAP
        chars.append(0x1203C)  # glyph00064	CUNEIFORM SIGN ASH OVER ASH OVER ASH
        chars.append(
            0x1203D
        )  # glyph00065	CUNEIFORM SIGN ASH OVER ASH OVER ASH CROSSING ASH OVER ASH OVER ASH
        ...
        chars.append(
            0x12057
        )  # glyph00091	CUNEIFORM SIGN DAG KISIM5 TIMES A PLUS MASH
        ...
        chars.append(
            0x1205C
        )  # glyph00096	CUNEIFORM SIGN DAG KISIM5 TIMES GA PLUS MASH
        ...
        chars.append(
            0x12062
        )  # glyph00102	CUNEIFORM SIGN DAG KISIM5 TIMES IR PLUS LU
        ...
        chars.append(
            0x12066
        )  # glyph00106	CUNEIFORM SIGN DAG KISIM5 TIMES LU PLUS MASH2
        ...
        chars.append(
            0x12069
        )  # glyph00109	CUNEIFORM SIGN DAG KISIM5 TIMES PAP PLUS PAP
        ...
        chars.append(
            0x1206C
        )  # glyph00112	CUNEIFORM SIGN DAG KISIM5 TIMES U2 PLUS GIR2
        ...
        chars.append(
            0x120A4
        )  # glyph00168	CUNEIFORM SIGN EZEN TIMES A PLUS LAL TIMES LAL
        ...
        chars.append(
            0x120B8
        )  # glyph00188	CUNEIFORM SIGN GA2 TIMES A PLUS DA PLUS HA
        ...
        chars.append(
            0x120BB
        )  # glyph00191	CUNEIFORM SIGN GA2 TIMES AB2 TENU PLUS TAB
        ...
        chars.append(
            0x120CA
        )  # glyph00206	CUNEIFORM SIGN GA2 TIMES EN TIMES GAN2 TENU
        ...
        chars.append(
            0x120D1
        )  # glyph00213	CUNEIFORM SIGN GA2 TIMES HA PLUS LU PLUS ESH2
        ...
        chars.append(
            0x120D7
        )  # glyph00219	CUNEIFORM SIGN GA2 TIMES ISH PLUS HU PLUS ASH
        ...
        chars.append(
            0x120F3
        )  # glyph00247	CUNEIFORM SIGN GAL GAD OVER GAD GAR OVER GAR
        ...
        chars.append(
            0x1211A
        )  # glyph00286	CUNEIFORM SIGN GU2 TIMES KAK TIMES IGI GUNU
        ...
        chars.append(
            0x12149
        )  # glyph00333	CUNEIFORM SIGN IGI OVER IGI SHIR OVER SHIR UD OVER UD
        ...
        chars.append(
            0x12166
        )  # glyph00362	CUNEIFORM SIGN KA TIMES GAR PLUS SHA3 PLUS A
        ...
        chars.append(
            0x1216A
        )  # glyph00366	CUNEIFORM SIGN KA TIMES GISH CROSSING GISH
        ...
        chars.append(
            0x1219D
        )  # glyph00417	CUNEIFORM SIGN KASKAL LAGAB TIMES U OVER LAGAB TIMES U
        chars.append(
            0x1219E
        )  # glyph00418	CUNEIFORM SIGN KASKAL OVER KASKAL LAGAB TIMES U OVER LAGAB TIMES U
        ...
        chars.append(
            0x121AB
        )  # glyph00431	CUNEIFORM SIGN KU OVER HI TIMES ASH2 KU OVER HI TIMES ASH2
        ...
        chars.append(
            0x121BA
        )  # glyph00446	CUNEIFORM SIGN LAGAB TIMES A PLUS DA PLUS HA
        ...
        chars.append(
            0x121D3
        )  # glyph00471	CUNEIFORM SIGN LAGAB TIMES KUL PLUS HI PLUS A
        ...
        chars.append(
            0x121DD
        )  # glyph00481	CUNEIFORM SIGN LAGAB TIMES SHITA PLUS GISH PLUS ERIN2
        chars.append(
            0x121DE
        )  # glyph00482	CUNEIFORM SIGN LAGAB TIMES SHITA PLUS GISH TENU
        ...
        chars.append(
            0x121E4
        )  # glyph00488	CUNEIFORM SIGN LAGAB TIMES TE PLUS A PLUS SU PLUS NA
        ...
        chars.append(
            0x121E7
        )  # glyph00491	CUNEIFORM SIGN LAGAB TIMES U PLUS U PLUS U
        ...
        chars.append(
            0x121F0
        )  # glyph00500	CUNEIFORM SIGN LAGAR GUNU OVER LAGAR GUNU SHE
        ...
        chars.append(
            0x12237
        )  # glyph00571	CUNEIFORM SIGN MUSH OVER MUSH TIMES A PLUS NA
        ...
        chars.append(
            0x12251
        )  # glyph00597	CUNEIFORM SIGN NIM TIMES GAR PLUS GAN2 TENU
        ...
        chars.append(
            0x12257
        )  # glyph00603	CUNEIFORM SIGN NINDA2 TIMES ME PLUS GAN2 TENU
        ...
        chars.append(
            0x1225D
        )  # glyph00609	CUNEIFORM SIGN NINDA2 TIMES SHE PLUS ASH PLUS ASH
        ...
        chars.append(
            0x12267
        )  # glyph00619	CUNEIFORM SIGN NUN LAGAR TIMES SAL OVER NUN LAGAR TIMES SAL
        ...
        chars.append(
            0x1226C
        )  # glyph00624	CUNEIFORM SIGN NUN CROSSING NUN LAGAR OVER LAGAR
        ...
        chars.append(
            0x122BC
        )  # glyph00704	CUNEIFORM SIGN SHE OVER SHE GAD OVER GAD GAR OVER GAR
        chars.append(
            0x122BD
        )  # glyph00705	CUNEIFORM SIGN SHE OVER SHE TAB OVER TAB GAR OVER GAR
        ...
        chars.append(
            0x122D5
        )  # glyph00729	CUNEIFORM SIGN SHIR OVER SHIR BUR OVER BUR
        ...
        chars.append(
            0x122F1
        )  # glyph00757	CUNEIFORM SIGN TAB OVER TAB NI OVER NI DISH OVER DISH
        ...
        chars.append(
            0x12304
        )  # glyph00776	CUNEIFORM SIGN TIR OVER TIR GAD OVER GAD GAR OVER GAR
        ...
        chars.append(
            0x1230E
        )  # glyph00786	CUNEIFORM SIGN U OVER U PA OVER PA GAR OVER GAR
        chars.append(0x1230F)  # glyph00787	CUNEIFORM SIGN U OVER U SUR OVER SUR
        chars.append(
            0x12310
        )  # glyph00788	CUNEIFORM SIGN U OVER U U REVERSED OVER U REVERSED
        ...
        chars.append(
            0x12318
        )  # glyph00796	CUNEIFORM SIGN UD TIMES U PLUS U PLUS U GUNU
        ...
        chars.append(
            0x12425
        )  # glyph00920	CUNEIFORM NUMERIC SIGN THREE SHAR2 VARIANT FORM
        ...
        chars.append(
            0x1242F
        )  # glyph00930	CUNEIFORM NUMERIC SIGN THREE SHARU VARIANT FORM
        ...
        chars.append(
            0x12432
        )  # glyph00933	CUNEIFORM NUMERIC SIGN SHAR2 TIMES GAL PLUS DISH
        chars.append(
            0x12433
        )  # glyph00934	CUNEIFORM NUMERIC SIGN SHAR2 TIMES GAL PLUS MIN
        ...
        chars.append(
            0x12437
        )  # glyph00938	CUNEIFORM NUMERIC SIGN THREE BURU VARIANT FORM
        ...
        chars.append(
            0x1243A
        )  # glyph00941	CUNEIFORM NUMERIC SIGN THREE VARIANT FORM ESH16
        chars.append(
            0x1243B
        )  # glyph00942	CUNEIFORM NUMERIC SIGN THREE VARIANT FORM ESH21
        chars.append(
            0x1243C
        )  # glyph00943	CUNEIFORM NUMERIC SIGN FOUR VARIANT FORM LIMMU
        chars.append(
            0x1243D
        )  # glyph00944	CUNEIFORM NUMERIC SIGN FOUR VARIANT FORM LIMMU4
        chars.append(
            0x1243E
        )  # glyph00945	CUNEIFORM NUMERIC SIGN FOUR VARIANT FORM LIMMU A
        chars.append(
            0x1243F
        )  # glyph00946	CUNEIFORM NUMERIC SIGN FOUR VARIANT FORM LIMMU B
        chars.append(
            0x12440
        )  # glyph00947	CUNEIFORM NUMERIC SIGN SIX VARIANT FORM ASH9
        chars.append(
            0x12441
        )  # glyph00948	CUNEIFORM NUMERIC SIGN SEVEN VARIANT FORM IMIN3
        chars.append(
            0x12442
        )  # glyph00949	CUNEIFORM NUMERIC SIGN SEVEN VARIANT FORM IMIN A
        chars.append(
            0x12443
        )  # glyph00950	CUNEIFORM NUMERIC SIGN SEVEN VARIANT FORM IMIN B
        chars.append(
            0x12444
        )  # glyph00951	CUNEIFORM NUMERIC SIGN EIGHT VARIANT FORM USSU
        chars.append(
            0x12445
        )  # glyph00952	CUNEIFORM NUMERIC SIGN EIGHT VARIANT FORM USSU3
        chars.append(
            0x12446
        )  # glyph00953	CUNEIFORM NUMERIC SIGN NINE VARIANT FORM ILIMMU
        chars.append(
            0x12447
        )  # glyph00954	CUNEIFORM NUMERIC SIGN NINE VARIANT FORM ILIMMU3
        chars.append(
            0x12448
        )  # glyph00955	CUNEIFORM NUMERIC SIGN NINE VARIANT FORM ILIMMU4
        chars.append(
            0x12449
        )  # glyph00956	CUNEIFORM NUMERIC SIGN NINE VARIANT FORM ILIMMU A
        ...
        chars.append(
            0x12453
        )  # glyph00966	CUNEIFORM NUMERIC SIGN FOUR BAN2 VARIANT FORM
        chars.append(0x12454)  # glyph00967	CUNEIFORM NUMERIC SIGN FIVE BAN2
        chars.append(
            0x12455
        )  # glyph00968	CUNEIFORM NUMERIC SIGN FIVE BAN2 VARIANT FORM
        ...
        chars.append(
            0x1245D
        )  # glyph00976	CUNEIFORM NUMERIC SIGN ONE THIRD VARIANT FORM A
        chars.append(
            0x1245E
        )  # glyph00977	CUNEIFORM NUMERIC SIGN TWO THIRDS VARIANT FORM A
        ...
        chars.append(
            0x12461
        )  # glyph00980	CUNEIFORM NUMERIC SIGN OLD ASSYRIAN ONE SIXTH
        chars.append(
            0x12462
        )  # glyph00981	CUNEIFORM NUMERIC SIGN OLD ASSYRIAN ONE QUARTER
        chars.append(
            0x12470
        )  # glyph00982	CUNEIFORM PUNCTUATION SIGN OLD ASSYRIAN WORD DIVIDER
        ...
        chars.append(
            0x12473
        )  # glyph00985	CUNEIFORM PUNCTUATION SIGN DIAGONAL TRICOLON
