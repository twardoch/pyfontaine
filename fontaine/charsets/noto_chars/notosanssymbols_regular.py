class Charset:
    ...
    def glyphs(self):
        ...
        chars.append(
            0x20EC
        )  # uni20EC	COMBINING RIGHTWARDS HARPOON WITH BARB DOWNWARDS
        chars.append(
            0x20ED
        )  # uni20ED	COMBINING LEFTWARDS HARPOON WITH BARB DOWNWARDS
        ...
        chars.append(
            0x21B9
        )  # uni21B9	LEFTWARDS ARROW TO BAR OVER RIGHTWARDS ARROW TO BAR
        ...
        chars.append(
            0x21EC
        )  # uni21EC	UPWARDS WHITE ARROW ON PEDESTAL WITH HORIZONTAL BAR
        chars.append(
            0x21ED
        )  # uni21ED	UPWARDS WHITE ARROW ON PEDESTAL WITH VERTICAL BAR
        ...
        chars.append(
            0x22AF
        )  # uni22AF	NEGATED DOUBLE VERTICAL BAR DOUBLE RIGHT TURNSTILE
        ...
        chars.append(
            0x22F3
        )  # uni22F3	ELEMENT OF WITH VERTICAL BAR AT END OF HORIZONTAL STROKE
        chars.append(
            0x22F4
        )  # uni22F4	SMALL ELEMENT OF WITH VERTICAL BAR AT END OF HORIZONTAL STROKE
        ...
        chars.append(
            0x22FB
        )  # uni22FB	CONTAINS WITH VERTICAL BAR AT END OF HORIZONTAL STROKE
        chars.append(
            0x22FC
        )  # uni22FC	SMALL CONTAINS WITH VERTICAL BAR AT END OF HORIZONTAL STROKE
        ...
        chars.append(
            0x23B0
        )  # uni23B0	UPPER LEFT OR LOWER RIGHT CURLY BRACKET SECTION
        chars.append(
            0x23B1
        )  # uni23B1	UPPER RIGHT OR LOWER LEFT CURLY BRACKET SECTION
        ...
        chars.append(
            0x23BF
        )  # uni23BF	DENTISTRY SYMBOL LIGHT VERTICAL AND BOTTOM RIGHT
        chars.append(0x23C0)  # uni23C0	DENTISTRY SYMBOL LIGHT VERTICAL WITH CIRCLE
        chars.append(0x00A0)  # uni00A0	NO-BREAK SPACE
        chars.append(
            0x23C2
        )  # uni23C2	DENTISTRY SYMBOL LIGHT UP AND HORIZONTAL WITH CIRCLE
        chars.append(0x23C3)  # uni23C3	DENTISTRY SYMBOL LIGHT VERTICAL WITH TRIANGLE
        chars.append(
            0x23C4
        )  # uni23C4	DENTISTRY SYMBOL LIGHT DOWN AND HORIZONTAL WITH TRIANGLE
        chars.append(
            0x23C5
        )  # uni23C5	DENTISTRY SYMBOL LIGHT UP AND HORIZONTAL WITH TRIANGLE
        chars.append(0x23C6)  # uni23C6	DENTISTRY SYMBOL LIGHT VERTICAL AND WAVE
        chars.append(
            0x23C7
        )  # uni23C7	DENTISTRY SYMBOL LIGHT DOWN AND HORIZONTAL WITH WAVE
        chars.append(
            0x23C8
        )  # uni23C8	DENTISTRY SYMBOL LIGHT UP AND HORIZONTAL WITH WAVE
        ...
        chars.append(
            0x23CC
        )  # uni23CC	DENTISTRY SYMBOL LIGHT VERTICAL AND BOTTOM LEFT
        ...
        chars.append(
            0x253D
        )  # uni253D	BOX DRAWINGS LEFT HEAVY AND RIGHT VERTICAL LIGHT
        chars.append(
            0x253E
        )  # uni253E	BOX DRAWINGS RIGHT HEAVY AND LEFT VERTICAL LIGHT
        chars.append(
            0x253F
        )  # uni253F	BOX DRAWINGS VERTICAL LIGHT AND HORIZONTAL HEAVY
        chars.append(
            0x2540
        )  # uni2540	BOX DRAWINGS UP HEAVY AND DOWN HORIZONTAL LIGHT
        chars.append(
            0x2541
        )  # uni2541	BOX DRAWINGS DOWN HEAVY AND UP HORIZONTAL LIGHT
        chars.append(
            0x2542
        )  # uni2542	BOX DRAWINGS VERTICAL HEAVY AND HORIZONTAL LIGHT
        chars.append(
            0x2543
        )  # uni2543	BOX DRAWINGS LEFT UP HEAVY AND RIGHT DOWN LIGHT
        chars.append(
            0x2544
        )  # uni2544	BOX DRAWINGS RIGHT UP HEAVY AND LEFT DOWN LIGHT
        chars.append(
            0x2545
        )  # uni2545	BOX DRAWINGS LEFT DOWN HEAVY AND RIGHT UP LIGHT
        chars.append(
            0x2546
        )  # uni2546	BOX DRAWINGS RIGHT DOWN HEAVY AND LEFT UP LIGHT
        chars.append(
            0x2547
        )  # uni2547	BOX DRAWINGS DOWN LIGHT AND UP HORIZONTAL HEAVY
        chars.append(
            0x2548
        )  # uni2548	BOX DRAWINGS UP LIGHT AND DOWN HORIZONTAL HEAVY
        chars.append(
            0x2549
        )  # uni2549	BOX DRAWINGS RIGHT LIGHT AND LEFT VERTICAL HEAVY
        chars.append(
            0x254A
        )  # uni254A	BOX DRAWINGS LEFT LIGHT AND RIGHT VERTICAL HEAVY
        ...
        chars.append(
            0x255E
        )  # SF360000	BOX DRAWINGS VERTICAL SINGLE AND RIGHT DOUBLE
        chars.append(
            0x255F
        )  # SF370000	BOX DRAWINGS VERTICAL DOUBLE AND RIGHT SINGLE
        ...
        chars.append(
            0x2564
        )  # SF470000	BOX DRAWINGS DOWN SINGLE AND HORIZONTAL DOUBLE
        chars.append(
            0x2565
        )  # SF480000	BOX DRAWINGS DOWN DOUBLE AND HORIZONTAL SINGLE
        ...
        chars.append(
            0x256A
        )  # SF540000	BOX DRAWINGS VERTICAL SINGLE AND HORIZONTAL DOUBLE
        chars.append(
            0x256B
        )  # SF530000	BOX DRAWINGS VERTICAL DOUBLE AND HORIZONTAL SINGLE
        ...
        chars.append(
            0x2571
        )  # uni2571	BOX DRAWINGS LIGHT DIAGONAL UPPER RIGHT TO LOWER LEFT
        chars.append(
            0x2572
        )  # uni2572	BOX DRAWINGS LIGHT DIAGONAL UPPER LEFT TO LOWER RIGHT
        ...
        chars.append(
            0x2599
        )  # uni2599	QUADRANT UPPER LEFT AND LOWER LEFT AND LOWER RIGHT
        chars.append(0x259A)  # uni259A	QUADRANT UPPER LEFT AND LOWER RIGHT
        chars.append(
            0x259B
        )  # uni259B	QUADRANT UPPER LEFT AND UPPER RIGHT AND LOWER LEFT
        chars.append(
            0x259C
        )  # uni259C	QUADRANT UPPER LEFT AND UPPER RIGHT AND LOWER RIGHT
        chars.append(0x259D)  # uni259D	QUADRANT UPPER RIGHT
        chars.append(0x259E)  # uni259E	QUADRANT UPPER RIGHT AND LOWER LEFT
        chars.append(
            0x259F
        )  # uni259F	QUADRANT UPPER RIGHT AND LOWER LEFT AND LOWER RIGHT
        ...
        chars.append(
            0x26DE
        )  # uni26DE	FALLING DIAGONAL IN WHITE CIRCLE IN BLACK SQUARE
        ...
        chars.append(
            0x26FF
        )  # uni26FF	WHITE FLAG WITH HORIZONTAL MIDDLE BLACK STRIPE
        ...
        chars.append(
            0x274B
        )  # uni274B	HEAVY EIGHT TEARDROP-SPOKED PROPELLER ASTERISK
        ...
        chars.append(
            0x275B
        )  # uni275B	HEAVY SINGLE TURNED COMMA QUOTATION MARK ORNAMENT
        chars.append(0x275C)  # uni275C	HEAVY SINGLE COMMA QUOTATION MARK ORNAMENT
        chars.append(
            0x275D
        )  # uni275D	HEAVY DOUBLE TURNED COMMA QUOTATION MARK ORNAMENT
        ...
        chars.append(
            0x276E
        )  # uni276E	HEAVY LEFT-POINTING ANGLE QUOTATION MARK ORNAMENT
        chars.append(
            0x276F
        )  # uni276F	HEAVY RIGHT-POINTING ANGLE QUOTATION MARK ORNAMENT
        ...
        chars.append(
            0x278C
        )  # uni278C	DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT THREE
        chars.append(
            0x278D
        )  # uni278D	DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT FOUR
        chars.append(
            0x278E
        )  # uni278E	DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT FIVE
        chars.append(0x278F)  # uni278F	DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT SIX
        chars.append(
            0x2790
        )  # uni2790	DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT SEVEN
        chars.append(
            0x2791
        )  # uni2791	DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT EIGHT
        chars.append(
            0x2792
        )  # uni2792	DINGBAT NEGATIVE CIRCLED SANS-SERIF DIGIT NINE
        chars.append(
            0x2793
        )  # uni2793	DINGBAT NEGATIVE CIRCLED SANS-SERIF NUMBER TEN
        ...
        chars.append(
            0x27A5
        )  # uni27A5	HEAVY BLACK CURVED DOWNWARDS AND RIGHTWARDS ARROW
        chars.append(
            0x27A6
        )  # uni27A6	HEAVY BLACK CURVED UPWARDS AND RIGHTWARDS ARROW
        ...
        chars.append(
            0x27AD
        )  # uni27AD	HEAVY LOWER RIGHT-SHADOWED WHITE RIGHTWARDS ARROW
        chars.append(
            0x27AE
        )  # uni27AE	HEAVY UPPER RIGHT-SHADOWED WHITE RIGHTWARDS ARROW
        chars.append(
            0x27AF
        )  # uni27AF	NOTCHED LOWER RIGHT-SHADOWED WHITE RIGHTWARDS ARROW
        chars.append(0x27B0)  # uni27B0	????
        chars.append(
            0x27B1
        )  # uni27B1	NOTCHED UPPER RIGHT-SHADOWED WHITE RIGHTWARDS ARROW
        ...
        chars.append(
            0x27C1
        )  # uni27C1	WHITE TRIANGLE CONTAINING SMALL WHITE TRIANGLE
        ...
        chars.append(
            0x27E2
        )  # uni27E2	WHITE CONCAVE-SIDED DIAMOND WITH LEFTWARDS TICK
        chars.append(
            0x27E3
        )  # uni27E3	WHITE CONCAVE-SIDED DIAMOND WITH RIGHTWARDS TICK
        ...
        chars.append(
            0x27EC
        )  # uni27EC	MATHEMATICAL LEFT WHITE TORTOISE SHELL BRACKET
        chars.append(
            0x27ED
        )  # uni27ED	MATHEMATICAL RIGHT WHITE TORTOISE SHELL BRACKET
        ...
        chars.append(
            0x2900
        )  # uni2900	RIGHTWARDS TWO-HEADED ARROW WITH VERTICAL STROKE
        chars.append(
            0x2901
        )  # uni2901	RIGHTWARDS TWO-HEADED ARROW WITH DOUBLE VERTICAL STROKE
        ...
        chars.append(
            0x2914
        )  # uni2914	RIGHTWARDS ARROW WITH TAIL WITH VERTICAL STROKE
        chars.append(
            0x2915
        )  # uni2915	RIGHTWARDS ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE
        chars.append(0x2916)  # uni2916	RIGHTWARDS TWO-HEADED ARROW WITH TAIL
        chars.append(
            0x2917
        )  # uni2917	RIGHTWARDS TWO-HEADED ARROW WITH TAIL WITH VERTICAL STROKE
        chars.append(
            0x2918
        )  # uni2918	RIGHTWARDS TWO-HEADED ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE
        ...
        chars.append(
            0x2934
        )  # uni2934	ARROW POINTING RIGHTWARDS THEN CURVING UPWARDS
        chars.append(
            0x2935
        )  # uni2935	ARROW POINTING RIGHTWARDS THEN CURVING DOWNWARDS
        chars.append(
            0x2936
        )  # uni2936	ARROW POINTING DOWNWARDS THEN CURVING LEFTWARDS
        chars.append(
            0x2937
        )  # uni2937	ARROW POINTING DOWNWARDS THEN CURVING RIGHTWARDS
        ...
        chars.append(
            0x2962
        )  # uni2962	LEFTWARDS HARPOON WITH BARB UP ABOVE LEFTWARDS HARPOON WITH BARB DOWN
        chars.append(
            0x2963
        )  # uni2963	UPWARDS HARPOON WITH BARB LEFT BESIDE UPWARDS HARPOON WITH BARB RIGHT
        chars.append(
            0x2964
        )  # uni2964	RIGHTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB DOWN
        chars.append(
            0x2965
        )  # uni2965	DOWNWARDS HARPOON WITH BARB LEFT BESIDE DOWNWARDS HARPOON WITH BARB RIGHT
        chars.append(
            0x2966
        )  # uni2966	LEFTWARDS HARPOON WITH BARB UP ABOVE RIGHTWARDS HARPOON WITH BARB UP
        chars.append(
            0x2967
        )  # uni2967	LEFTWARDS HARPOON WITH BARB DOWN ABOVE RIGHTWARDS HARPOON WITH BARB DOWN
        chars.append(
            0x2968
        )  # uni2968	RIGHTWARDS HARPOON WITH BARB UP ABOVE LEFTWARDS HARPOON WITH BARB UP
        chars.append(
            0x2969
        )  # uni2969	RIGHTWARDS HARPOON WITH BARB DOWN ABOVE LEFTWARDS HARPOON WITH BARB DOWN
        chars.append(
            0x296A
        )  # uni296A	LEFTWARDS HARPOON WITH BARB UP ABOVE LONG DASH
        chars.append(
            0x296B
        )  # uni296B	LEFTWARDS HARPOON WITH BARB DOWN BELOW LONG DASH
        chars.append(
            0x296C
        )  # uni296C	RIGHTWARDS HARPOON WITH BARB UP ABOVE LONG DASH
        chars.append(
            0x296D
        )  # uni296D	RIGHTWARDS HARPOON WITH BARB DOWN BELOW LONG DASH
        chars.append(
            0x296E
        )  # uni296E	UPWARDS HARPOON WITH BARB LEFT BESIDE DOWNWARDS HARPOON WITH BARB RIGHT
        chars.append(
            0x296F
        )  # uni296F	DOWNWARDS HARPOON WITH BARB LEFT BESIDE UPWARDS HARPOON WITH BARB RIGHT
        ...
        chars.append(
            0x298E
        )  # uni298E	RIGHT SQUARE BRACKET WITH TICK IN BOTTOM CORNER
        chars.append(
            0x298F
        )  # uni298F	LEFT SQUARE BRACKET WITH TICK IN BOTTOM CORNER
        ...
        chars.append(
            0x29A8
        )  # uni29A8	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING UP AND RIGHT
        chars.append(
            0x29A9
        )  # uni29A9	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING UP AND LEFT
        chars.append(
            0x29AA
        )  # uni29AA	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING DOWN AND RIGHT
        chars.append(
            0x29AB
        )  # uni29AB	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING DOWN AND LEFT
        chars.append(
            0x29AC
        )  # uni29AC	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING RIGHT AND UP
        chars.append(
            0x29AD
        )  # uni29AD	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING LEFT AND UP
        chars.append(
            0x29AE
        )  # uni29AE	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING RIGHT AND DOWN
        chars.append(
            0x29AF
        )  # uni29AF	MEASURED ANGLE WITH OPEN ARM ENDING IN ARROW POINTING LEFT AND DOWN
        ...
        chars.append(
            0x29BA
        )  # uni29BA	CIRCLE DIVIDED BY HORIZONTAL BAR AND TOP HALF DIVIDED BY VERTICAL BAR
        ...
        chars.append(
            0x29C3
        )  # uni29C3	CIRCLE WITH TWO HORIZONTAL STROKES TO THE RIGHT
        ...
        chars.append(
            0x29E4
        )  # uni29E4	EQUALS SIGN AND SLANTED PARALLEL WITH TILDE ABOVE
        ...
        chars.append(
            0x2A12
        )  # uni2A12	LINE INTEGRATION WITH RECTANGULAR PATH AROUND POLE
        chars.append(
            0x2A13
        )  # uni2A13	LINE INTEGRATION WITH SEMICIRCULAR PATH AROUND POLE
        ...
        chars.append(
            0x2A36
        )  # uni2A36	CIRCLED MULTIPLICATION SIGN WITH CIRCUMFLEX ACCENT
        ...
        chars.append(
            0x2A4B
        )  # uni2A4B	INTERSECTION BESIDE AND JOINED WITH INTERSECTION
        ...
        chars.append(
            0x2A68
        )  # uni2A68	TRIPLE HORIZONTAL BAR WITH DOUBLE VERTICAL STROKE
        chars.append(
            0x2A69
        )  # uni2A69	TRIPLE HORIZONTAL BAR WITH TRIPLE VERTICAL STROKE
        ...
        chars.append(
            0x2A77
        )  # uni2A77	EQUALS SIGN WITH TWO DOTS ABOVE AND TWO DOTS BELOW
        ...
        chars.append(
            0x2A80
        )  # uni2A80	GREATER-THAN OR SLANTED EQUAL TO WITH DOT INSIDE
        chars.append(0x2A81)  # uni2A81	LESS-THAN OR SLANTED EQUAL TO WITH DOT ABOVE
        chars.append(
            0x2A82
        )  # uni2A82	GREATER-THAN OR SLANTED EQUAL TO WITH DOT ABOVE
        chars.append(
            0x2A83
        )  # uni2A83	LESS-THAN OR SLANTED EQUAL TO WITH DOT ABOVE RIGHT
        chars.append(
            0x2A84
        )  # uni2A84	GREATER-THAN OR SLANTED EQUAL TO WITH DOT ABOVE LEFT
        ...
        chars.append(
            0x2A8B
        )  # uni2A8B	LESS-THAN ABOVE DOUBLE-LINE EQUAL ABOVE GREATER-THAN
        chars.append(
            0x2A8C
        )  # uni2A8C	GREATER-THAN ABOVE DOUBLE-LINE EQUAL ABOVE LESS-THAN
        ...
        chars.append(
            0x2A91
        )  # uni2A91	LESS-THAN ABOVE GREATER-THAN ABOVE DOUBLE-LINE EQUAL
        chars.append(
            0x2A92
        )  # uni2A92	GREATER-THAN ABOVE LESS-THAN ABOVE DOUBLE-LINE EQUAL
        chars.append(
            0x2A93
        )  # uni2A93	LESS-THAN ABOVE SLANTED EQUAL ABOVE GREATER-THAN ABOVE SLANTED EQUAL
        chars.append(
            0x2A94
        )  # uni2A94	GREATER-THAN ABOVE SLANTED EQUAL ABOVE LESS-THAN ABOVE SLANTED EQUAL
        ...
        chars.append(
            0x2A98
        )  # uni2A98	SLANTED EQUAL TO OR GREATER-THAN WITH DOT INSIDE
        ...
        chars.append(
            0x2AA9
        )  # uni2AA9	GREATER-THAN CLOSED BY CURVE ABOVE SLANTED EQUAL
        ...
        chars.append(
            0x2AD8
        )  # uni2AD8	SUPERSET BESIDE AND JOINED BY DASH WITH SUBSET
        ...
        chars.append(
            0x2B34
        )  # uni2B34	LEFTWARDS TWO-HEADED ARROW WITH VERTICAL STROKE
        chars.append(
            0x2B35
        )  # uni2B35	LEFTWARDS TWO-HEADED ARROW WITH DOUBLE VERTICAL STROKE
        ...
        chars.append(
            0x2B39
        )  # uni2B39	LEFTWARDS ARROW WITH TAIL WITH VERTICAL STROKE
        chars.append(
            0x2B3A
        )  # uni2B3A	LEFTWARDS ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE
        chars.append(0x2B3B)  # uni2B3B	LEFTWARDS TWO-HEADED ARROW WITH TAIL
        chars.append(
            0x2B3C
        )  # uni2B3C	LEFTWARDS TWO-HEADED ARROW WITH TAIL WITH VERTICAL STROKE
        chars.append(
            0x2B3D
        )  # uni2B3D	LEFTWARDS TWO-HEADED ARROW WITH TAIL WITH DOUBLE VERTICAL STROKE
        ...
        chars.append(
            0x2B48
        )  # uni2B48	RIGHTWARDS ARROW ABOVE REVERSE ALMOST EQUAL TO
        ...
        chars.append(
            0x23C1
        )  # uni23C1	DENTISTRY SYMBOL LIGHT DOWN AND HORIZONTAL WITH CIRCLE
        ...
        chars.append(
            0xA70D
        )  # uniA70D	MODIFIER LETTER EXTRA-HIGH DOTTED LEFT-STEM TONE BAR
        chars.append(
            0xA70E
        )  # uniA70E	MODIFIER LETTER HIGH DOTTED LEFT-STEM TONE BAR
        ...
        chars.append(
            0xA711
        )  # uniA711	MODIFIER LETTER EXTRA-LOW DOTTED LEFT-STEM TONE BAR
        ...
        chars.append(
            0xA71E
        )  # uniA71E	MODIFIER LETTER RAISED INVERTED EXCLAMATION MARK
        ...
        chars.append(
            0x10152
        )  # glyph02826	GREEK ACROPHONIC ATTIC ONE HUNDRED STATERS
        chars.append(
            0x10153
        )  # glyph02827	GREEK ACROPHONIC ATTIC FIVE HUNDRED STATERS
        chars.append(
            0x10154
        )  # glyph02828	GREEK ACROPHONIC ATTIC ONE THOUSAND STATERS
        chars.append(
            0x10155
        )  # glyph02829	GREEK ACROPHONIC ATTIC TEN THOUSAND STATERS
        chars.append(
            0x10156
        )  # glyph02830	GREEK ACROPHONIC ATTIC FIFTY THOUSAND STATERS
        ...
        chars.append(
            0x10161
        )  # glyph02841	GREEK ACROPHONIC TROEZENIAN TEN ALTERNATE FORM
        ...
        chars.append(
            0x10167
        )  # glyph02847	GREEK ACROPHONIC TROEZENIAN FIFTY ALTERNATE FORM
        ...
        chars.append(
            0x1D0B1
        )  # glyph03118	BYZANTINE MUSICAL SYMBOL MARTYRIA VARYS ICHOS
        ...
        chars.append(
            0x101FD
        )  # glyph02940	PHAISTOS DISC SIGN COMBINING OBLIQUE STROKE
        ...
        chars.append(
            0x1D76A
        )  # glyph04430	MATHEMATICAL SANS-SERIF BOLD CAPITAL UPSILON
        ...
        chars.append(
            0x1F240
        )  # glyph04998	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-672C
        chars.append(0x1F73D)  # glyph05070	????
        chars.append(
            0x1F241
        )  # glyph04999	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-4E09
        chars.append(0x1D710)  # glyph04340	MATHEMATICAL ITALIC SMALL UPSILON
        chars.append(
            0x1F242
        )  # glyph05000	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-4E8C
        chars.append(0x1F100)  # glyph04781	DIGIT ZERO FULL STOP
        chars.append(0x10140)  # glyph02808	GREEK ACROPHONIC ATTIC ONE QUARTER
        chars.append(
            0x1D798
        )  # glyph04476	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL IOTA
        chars.append(0x1F178)  # glyph04891	????
        chars.append(0x1F0B1)  # glyph04737	????
        chars.append(
            0x1F244
        )  # glyph05002	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-70B9
        chars.append(
            0x1F245
        )  # glyph05003	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-6253
        ...
        chars.append(
            0x1D7B6
        )  # glyph04506	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL NU
        ...
        chars.append(
            0x1D7BE
        )  # glyph04514	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL UPSILON
        ...
        chars.append(
            0x1D7C4
        )  # glyph04520	MATHEMATICAL SANS-SERIF BOLD ITALIC EPSILON SYMBOL
        ...
        chars.append(
            0x1014B
        )  # glyph02819	GREEK ACROPHONIC ATTIC ONE HUNDRED TALENTS
        ...
        chars.append(
            0x1014C
        )  # glyph02820	GREEK ACROPHONIC ATTIC FIVE HUNDRED TALENTS
        ...
        chars.append(
            0x1014D
        )  # glyph02821	GREEK ACROPHONIC ATTIC ONE THOUSAND TALENTS
        ...
        chars.append(
            0x1014E
        )  # glyph02822	GREEK ACROPHONIC ATTIC FIVE THOUSAND TALENTS
        ...
        chars.append(
            0x1D003
        )  # glyph02944	BYZANTINE MUSICAL SYMBOL OXEIA EKFONITIKON
        chars.append(0x1D004)  # glyph02945	BYZANTINE MUSICAL SYMBOL OXEIA DIPLI
        chars.append(
            0x1D005
        )  # glyph02946	BYZANTINE MUSICAL SYMBOL VAREIA EKFONITIKON
        ...
        chars.append(
            0x1D00D
        )  # glyph02954	BYZANTINE MUSICAL SYMBOL APESO EKFONITIKON
        ...
        chars.append(
            0x1D01C
        )  # glyph02969	BYZANTINE MUSICAL SYMBOL KENTIMATA ARCHAION
        ...
        chars.append(
            0x1D022
        )  # glyph02975	BYZANTINE MUSICAL SYMBOL APODERMA ARCHAION
        ...
        chars.append(
            0x1D02B
        )  # glyph02984	BYZANTINE MUSICAL SYMBOL SYNAGMA META STAVROU
        chars.append(
            0x1D02C
        )  # glyph02985	BYZANTINE MUSICAL SYMBOL OYRANISMA ARCHAION
        ...
        chars.append(
            0x1D036
        )  # glyph02995	BYZANTINE MUSICAL SYMBOL TROMIKON ARCHAION
        ...
        chars.append(
            0x1D03B
        )  # glyph03000	BYZANTINE MUSICAL SYMBOL CHOREVMA ARCHAION
        chars.append(0x1D03C)  # glyph03001	BYZANTINE MUSICAL SYMBOL RAPISMA
        chars.append(
            0x1D03D
        )  # glyph03002	BYZANTINE MUSICAL SYMBOL PARAKALESMA ARCHAION
        chars.append(
            0x1D03E
        )  # glyph03003	BYZANTINE MUSICAL SYMBOL PARAKLITIKI ARCHAION
        ...
        chars.append(
            0x1D04E
        )  # glyph03019	BYZANTINE MUSICAL SYMBOL KENTIMATA NEO ANO
        ...
        chars.append(
            0x1D052
        )  # glyph03023	BYZANTINE MUSICAL SYMBOL APOSTROFOI SYNDESMOS NEO
        ...
        chars.append(
            0x1D060
        )  # glyph03037	BYZANTINE MUSICAL SYMBOL ETERON PARAKALESMA
        ...
        chars.append(
            0x1D06E
        )  # glyph03051	BYZANTINE MUSICAL SYMBOL TROMIKOPARAKALESMA
        chars.append(
            0x1D06F
        )  # glyph03052	BYZANTINE MUSICAL SYMBOL PSIFISTOPARAKALESMA
        ...
        chars.append(
            0x1D074
        )  # glyph03057	BYZANTINE MUSICAL SYMBOL ETERON ARGOSYNTHETON
        ...
        chars.append(
            0x1D08A
        )  # glyph03079	BYZANTINE MUSICAL SYMBOL LEIMMA ENOS CHRONOU
        chars.append(
            0x1D08B
        )  # glyph03080	BYZANTINE MUSICAL SYMBOL LEIMMA DYO CHRONON
        chars.append(
            0x1D08C
        )  # glyph03081	BYZANTINE MUSICAL SYMBOL LEIMMA TRION CHRONON
        chars.append(
            0x1D08D
        )  # glyph03082	BYZANTINE MUSICAL SYMBOL LEIMMA TESSARON CHRONON
        chars.append(
            0x1D08E
        )  # glyph03083	BYZANTINE MUSICAL SYMBOL LEIMMA IMISEOS CHRONOU
        chars.append(0x1D08F)  # glyph03084	BYZANTINE MUSICAL SYMBOL GORGON NEO ANO
        chars.append(
            0x1D090
        )  # glyph03085	BYZANTINE MUSICAL SYMBOL GORGON PARESTIGMENON ARISTERA
        chars.append(
            0x1D091
        )  # glyph03086	BYZANTINE MUSICAL SYMBOL GORGON PARESTIGMENON DEXIA
        chars.append(0x1D092)  # glyph03087	BYZANTINE MUSICAL SYMBOL DIGORGON
        chars.append(
            0x1D093
        )  # glyph03088	BYZANTINE MUSICAL SYMBOL DIGORGON PARESTIGMENON ARISTERA KATO
        chars.append(
            0x1D094
        )  # glyph03089	BYZANTINE MUSICAL SYMBOL DIGORGON PARESTIGMENON ARISTERA ANO
        chars.append(
            0x1D095
        )  # glyph03090	BYZANTINE MUSICAL SYMBOL DIGORGON PARESTIGMENON DEXIA
        ...
        chars.append(
            0x1D0A2
        )  # glyph03103	BYZANTINE MUSICAL SYMBOL MARTYRIA PROTOS ICHOS
        chars.append(
            0x1D0A3
        )  # glyph03104	BYZANTINE MUSICAL SYMBOL MARTYRIA ALLI PROTOS ICHOS
        chars.append(
            0x1D0A4
        )  # glyph03105	BYZANTINE MUSICAL SYMBOL MARTYRIA DEYTEROS ICHOS
        chars.append(
            0x1D0A5
        )  # glyph03106	BYZANTINE MUSICAL SYMBOL MARTYRIA ALLI DEYTEROS ICHOS
        chars.append(
            0x1D0A6
        )  # glyph03107	BYZANTINE MUSICAL SYMBOL MARTYRIA TRITOS ICHOS
        chars.append(
            0x1D0A7
        )  # glyph03108	BYZANTINE MUSICAL SYMBOL MARTYRIA TRIFONIAS
        chars.append(
            0x1D0A8
        )  # glyph03109	BYZANTINE MUSICAL SYMBOL MARTYRIA TETARTOS ICHOS
        chars.append(
            0x1D0A9
        )  # glyph03110	BYZANTINE MUSICAL SYMBOL MARTYRIA TETARTOS LEGETOS ICHOS
        chars.append(
            0x1D0AA
        )  # glyph03111	BYZANTINE MUSICAL SYMBOL MARTYRIA LEGETOS ICHOS
        chars.append(
            0x1D0AB
        )  # glyph03112	BYZANTINE MUSICAL SYMBOL MARTYRIA PLAGIOS ICHOS
        chars.append(
            0x1D0AC
        )  # glyph03113	BYZANTINE MUSICAL SYMBOL ISAKIA TELOUS ICHIMATOS
        chars.append(
            0x1D0AD
        )  # glyph03114	BYZANTINE MUSICAL SYMBOL APOSTROFOI TELOUS ICHIMATOS
        chars.append(
            0x1D0AE
        )  # glyph03115	BYZANTINE MUSICAL SYMBOL FANEROSIS TETRAFONIAS
        chars.append(
            0x1D0AF
        )  # glyph03116	BYZANTINE MUSICAL SYMBOL FANEROSIS MONOFONIAS
        chars.append(
            0x1D0B0
        )  # glyph03117	BYZANTINE MUSICAL SYMBOL FANEROSIS DIFONIAS
        chars.append(0x1011F)  # glyph02778	AEGEAN NUMBER SEVEN HUNDRED
        chars.append(
            0x1D0B2
        )  # glyph03119	BYZANTINE MUSICAL SYMBOL MARTYRIA PROTOVARYS ICHOS
        chars.append(
            0x1D0B3
        )  # glyph03120	BYZANTINE MUSICAL SYMBOL MARTYRIA PLAGIOS TETARTOS ICHOS
        chars.append(
            0x1D0B4
        )  # glyph03121	BYZANTINE MUSICAL SYMBOL GORTHMIKON N APLOUN
        chars.append(
            0x1D0B5
        )  # glyph03122	BYZANTINE MUSICAL SYMBOL GORTHMIKON N DIPLOUN
        chars.append(
            0x1D0B6
        )  # glyph03123	BYZANTINE MUSICAL SYMBOL ENARXIS KAI FTHORA VOU
        ...
        chars.append(
            0x1D0B9
        )  # glyph03126	BYZANTINE MUSICAL SYMBOL FTHORA ARCHAION DEYTEROU ICHOU
        chars.append(
            0x1D0BA
        )  # glyph03127	BYZANTINE MUSICAL SYMBOL FTHORA DIATONIKI PA
        chars.append(
            0x1D0BB
        )  # glyph03128	BYZANTINE MUSICAL SYMBOL FTHORA DIATONIKI NANA
        chars.append(
            0x1D0BC
        )  # glyph03129	BYZANTINE MUSICAL SYMBOL FTHORA NAOS ICHOS
        chars.append(
            0x1D0BD
        )  # glyph03130	BYZANTINE MUSICAL SYMBOL FTHORA DIATONIKI DI
        chars.append(
            0x1D0BE
        )  # glyph03131	BYZANTINE MUSICAL SYMBOL FTHORA SKLIRON DIATONON DI
        chars.append(
            0x1D0BF
        )  # glyph03132	BYZANTINE MUSICAL SYMBOL FTHORA DIATONIKI KE
        chars.append(
            0x1D0C0
        )  # glyph03133	BYZANTINE MUSICAL SYMBOL FTHORA DIATONIKI ZO
        chars.append(
            0x1D0C1
        )  # glyph03134	BYZANTINE MUSICAL SYMBOL FTHORA DIATONIKI NI KATO
        chars.append(
            0x1D0C2
        )  # glyph03135	BYZANTINE MUSICAL SYMBOL FTHORA DIATONIKI NI ANO
        chars.append(
            0x1D0C3
        )  # glyph03136	BYZANTINE MUSICAL SYMBOL FTHORA MALAKON CHROMA DIFONIAS
        chars.append(
            0x1D0C4
        )  # glyph03137	BYZANTINE MUSICAL SYMBOL FTHORA MALAKON CHROMA MONOFONIAS
        chars.append(
            0x1D0C5
        )  # glyph03138	BYZANTINE MUSICAL SYMBOL FHTORA SKLIRON CHROMA VASIS
        chars.append(
            0x1D0C6
        )  # glyph03139	BYZANTINE MUSICAL SYMBOL FTHORA SKLIRON CHROMA SYNAFI
        ...
        chars.append(
            0x1D0CB
        )  # glyph03144	BYZANTINE MUSICAL SYMBOL FTHORA I YFESIS TETARTIMORION
        chars.append(
            0x1D0CC
        )  # glyph03145	BYZANTINE MUSICAL SYMBOL FTHORA ENARMONIOS ANTIFONIA
        chars.append(
            0x1D0CD
        )  # glyph03146	BYZANTINE MUSICAL SYMBOL YFESIS TRITIMORION
        chars.append(
            0x1D0CE
        )  # glyph03147	BYZANTINE MUSICAL SYMBOL DIESIS TRITIMORION
        chars.append(
            0x1D0CF
        )  # glyph03148	BYZANTINE MUSICAL SYMBOL DIESIS TETARTIMORION
        chars.append(
            0x1D0D0
        )  # glyph03149	BYZANTINE MUSICAL SYMBOL DIESIS APLI DYO DODEKATA
        chars.append(
            0x1D0D1
        )  # glyph03150	BYZANTINE MUSICAL SYMBOL DIESIS MONOGRAMMOS TESSERA DODEKATA
        chars.append(
            0x1D0D2
        )  # glyph03151	BYZANTINE MUSICAL SYMBOL DIESIS DIGRAMMOS EX DODEKATA
        chars.append(
            0x1D0D3
        )  # glyph03152	BYZANTINE MUSICAL SYMBOL DIESIS TRIGRAMMOS OKTO DODEKATA
        chars.append(
            0x1D0D4
        )  # glyph03153	BYZANTINE MUSICAL SYMBOL YFESIS APLI DYO DODEKATA
        chars.append(
            0x1D0D5
        )  # glyph03154	BYZANTINE MUSICAL SYMBOL YFESIS MONOGRAMMOS TESSERA DODEKATA
        chars.append(
            0x1D0D6
        )  # glyph03155	BYZANTINE MUSICAL SYMBOL YFESIS DIGRAMMOS EX DODEKATA
        chars.append(
            0x1D0D7
        )  # glyph03156	BYZANTINE MUSICAL SYMBOL YFESIS TRIGRAMMOS OKTO DODEKATA
        ...
        chars.append(
            0x1D0DA
        )  # glyph03159	BYZANTINE MUSICAL SYMBOL DIASTOLI APLI MIKRI
        chars.append(
            0x1D0DB
        )  # glyph03160	BYZANTINE MUSICAL SYMBOL DIASTOLI APLI MEGALI
        ...
        chars.append(
            0x1D0DF
        )  # glyph03164	BYZANTINE MUSICAL SYMBOL SIMANSIS THESEOS DISIMOU
        chars.append(
            0x1D0E0
        )  # glyph03165	BYZANTINE MUSICAL SYMBOL SIMANSIS THESEOS TRISIMOU
        chars.append(
            0x1D0E1
        )  # glyph03166	BYZANTINE MUSICAL SYMBOL SIMANSIS THESEOS TETRASIMOU
        chars.append(0x1D0E2)  # glyph03167	BYZANTINE MUSICAL SYMBOL SIMANSIS ARSEOS
        chars.append(
            0x1D0E3
        )  # glyph03168	BYZANTINE MUSICAL SYMBOL SIMANSIS ARSEOS DISIMOU
        chars.append(
            0x1D0E4
        )  # glyph03169	BYZANTINE MUSICAL SYMBOL SIMANSIS ARSEOS TRISIMOU
        chars.append(
            0x1D0E5
        )  # glyph03170	BYZANTINE MUSICAL SYMBOL SIMANSIS ARSEOS TETRASIMOU
        ...
        chars.append(
            0x1D0F0
        )  # glyph03181	BYZANTINE MUSICAL SYMBOL KENTIMATA NEO MESO
        chars.append(0x1D0F1)  # glyph03182	BYZANTINE MUSICAL SYMBOL KENTIMA NEO MESO
        chars.append(
            0x1D0F2
        )  # glyph03183	BYZANTINE MUSICAL SYMBOL KENTIMATA NEO KATO
        ...
        chars.append(
            0x1D142
        )  # glyph03251	MUSICAL SYMBOL ONE HUNDRED TWENTY-EIGHTH REST
        ...
        chars.append(
            0x1D14A
        )  # glyph03259	MUSICAL SYMBOL TRIANGLE NOTEHEAD LEFT WHITE
        chars.append(
            0x1D14B
        )  # glyph03260	MUSICAL SYMBOL TRIANGLE NOTEHEAD LEFT BLACK
        chars.append(0x10120)  # glyph02779	AEGEAN NUMBER EIGHT HUNDRED
        chars.append(
            0x1D14D
        )  # glyph03262	MUSICAL SYMBOL TRIANGLE NOTEHEAD RIGHT BLACK
        chars.append(
            0x1D14E
        )  # glyph03263	MUSICAL SYMBOL TRIANGLE NOTEHEAD DOWN WHITE
        chars.append(
            0x1D14F
        )  # glyph03264	MUSICAL SYMBOL TRIANGLE NOTEHEAD DOWN BLACK
        chars.append(
            0x1D150
        )  # glyph03265	MUSICAL SYMBOL TRIANGLE NOTEHEAD UP RIGHT WHITE
        chars.append(
            0x1D151
        )  # glyph03266	MUSICAL SYMBOL TRIANGLE NOTEHEAD UP RIGHT BLACK
        ...
        chars.append(
            0x1D154
        )  # glyph03269	MUSICAL SYMBOL TRIANGLE-ROUND NOTEHEAD DOWN WHITE
        chars.append(
            0x1D155
        )  # glyph03270	MUSICAL SYMBOL TRIANGLE-ROUND NOTEHEAD DOWN BLACK
        ...
        chars.append(
            0x1D164
        )  # glyph03285	MUSICAL SYMBOL ONE HUNDRED TWENTY-EIGHTH NOTE
        chars.append(0x1D165)  # glyph03286	MUSICAL SYMBOL COMBINING STEM
        chars.append(
            0x1D166
        )  # glyph03287	MUSICAL SYMBOL COMBINING SPRECHGESANG STEM
        ...
        chars.append(
            0x1D1C7
        )  # glyph03384	MUSICAL SYMBOL TEMPUS PERFECTUM CUM PROLATIONE PERFECTA
        chars.append(
            0x1D1C8
        )  # glyph03385	MUSICAL SYMBOL TEMPUS PERFECTUM CUM PROLATIONE IMPERFECTA
        chars.append(
            0x1D1C9
        )  # glyph03386	MUSICAL SYMBOL TEMPUS PERFECTUM CUM PROLATIONE PERFECTA DIMINUTION-1
        chars.append(
            0x1D1CA
        )  # glyph03387	MUSICAL SYMBOL TEMPUS IMPERFECTUM CUM PROLATIONE PERFECTA
        chars.append(
            0x1D1CB
        )  # glyph03388	MUSICAL SYMBOL TEMPUS IMPERFECTUM CUM PROLATIONE IMPERFECTA
        chars.append(
            0x1D1CC
        )  # glyph03389	MUSICAL SYMBOL TEMPUS IMPERFECTUM CUM PROLATIONE IMPERFECTA DIMINUTION-1
        chars.append(
            0x1D1CD
        )  # glyph03390	MUSICAL SYMBOL TEMPUS IMPERFECTUM CUM PROLATIONE IMPERFECTA DIMINUTION-2
        chars.append(
            0x1D1CE
        )  # glyph03391	MUSICAL SYMBOL TEMPUS IMPERFECTUM CUM PROLATIONE IMPERFECTA DIMINUTION-3
        ...
        chars.append(
            0x1F246
        )  # glyph05004	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-76D7
        chars.append(
            0x1F247
        )  # glyph05005	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-52DD
        chars.append(
            0x1F248
        )  # glyph05006	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-6557
        ...
        chars.append(
            0x1F12A
        )  # glyph04818	TORTOISE SHELL BRACKETED LATIN CAPITAL LETTER S
        ...
        chars.append(
            0x1F243
        )  # glyph05001	TORTOISE SHELL BRACKETED CJK UNIFIED IDEOGRAPH-5B89
        ...
        chars.append(
            0x1D14C
        )  # glyph03261	MUSICAL SYMBOL TRIANGLE NOTEHEAD RIGHT WHITE
        ...
        chars.append(
            0x1D63C
        )  # glyph04130	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL A
        chars.append(
            0x1D63D
        )  # glyph04131	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL B
        chars.append(
            0x1D63E
        )  # glyph04132	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL C
        chars.append(
            0x1D63F
        )  # glyph04133	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL D
        chars.append(
            0x1D640
        )  # glyph04134	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL E
        chars.append(
            0x1D641
        )  # glyph04135	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL F
        chars.append(
            0x1D642
        )  # glyph04136	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL G
        chars.append(
            0x1D643
        )  # glyph04137	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL H
        chars.append(
            0x1D644
        )  # glyph04138	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL I
        chars.append(
            0x1D645
        )  # glyph04139	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL J
        chars.append(
            0x1D646
        )  # glyph04140	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL K
        chars.append(
            0x1D647
        )  # glyph04141	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL L
        chars.append(
            0x1D648
        )  # glyph04142	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL M
        chars.append(
            0x1D649
        )  # glyph04143	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL N
        chars.append(
            0x1D64A
        )  # glyph04144	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL O
        chars.append(
            0x1D64B
        )  # glyph04145	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL P
        chars.append(
            0x1D64C
        )  # glyph04146	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL Q
        chars.append(
            0x1D64D
        )  # glyph04147	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL R
        chars.append(
            0x1D64E
        )  # glyph04148	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL S
        chars.append(
            0x1D64F
        )  # glyph04149	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL T
        chars.append(
            0x1D650
        )  # glyph04150	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL U
        chars.append(
            0x1D651
        )  # glyph04151	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL V
        chars.append(
            0x1D652
        )  # glyph04152	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL W
        chars.append(
            0x1D653
        )  # glyph04153	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL X
        chars.append(
            0x1D654
        )  # glyph04154	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL Y
        chars.append(
            0x1D655
        )  # glyph04155	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL Z
        chars.append(
            0x1D656
        )  # glyph04156	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL A
        chars.append(
            0x1D657
        )  # glyph04157	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL B
        chars.append(
            0x1D658
        )  # glyph04158	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL C
        chars.append(
            0x1D659
        )  # glyph04159	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL D
        chars.append(
            0x1D65A
        )  # glyph04160	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL E
        chars.append(
            0x1D65B
        )  # glyph04161	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL F
        chars.append(
            0x1D65C
        )  # glyph04162	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL G
        chars.append(
            0x1D65D
        )  # glyph04163	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL H
        chars.append(
            0x1D65E
        )  # glyph04164	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL I
        chars.append(
            0x1D65F
        )  # glyph04165	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL J
        chars.append(
            0x1D660
        )  # glyph04166	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL K
        chars.append(
            0x1D661
        )  # glyph04167	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL L
        chars.append(
            0x1D662
        )  # glyph04168	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL M
        chars.append(
            0x1D663
        )  # glyph04169	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL N
        chars.append(
            0x1D664
        )  # glyph04170	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL O
        chars.append(
            0x1D665
        )  # glyph04171	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL P
        chars.append(
            0x1D666
        )  # glyph04172	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL Q
        chars.append(
            0x1D667
        )  # glyph04173	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL R
        chars.append(
            0x1D668
        )  # glyph04174	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL S
        chars.append(
            0x1D669
        )  # glyph04175	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL T
        chars.append(
            0x1D66A
        )  # glyph04176	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL U
        chars.append(
            0x1D66B
        )  # glyph04177	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL V
        chars.append(
            0x1D66C
        )  # glyph04178	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL W
        chars.append(
            0x1D66D
        )  # glyph04179	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL X
        chars.append(
            0x1D66E
        )  # glyph04180	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL Y
        chars.append(
            0x1D66F
        )  # glyph04181	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL Z
        ...
        chars.append(
            0x1D72D
        )  # glyph04369	MATHEMATICAL BOLD ITALIC CAPITAL THETA SYMBOL
        ...
        chars.append(
            0x1D747
        )  # glyph04395	MATHEMATICAL BOLD ITALIC SMALL FINAL SIGMA
        ...
        chars.append(
            0x1D74F
        )  # glyph04403	MATHEMATICAL BOLD ITALIC PARTIAL DIFFERENTIAL
        ...
        chars.append(
            0x1D756
        )  # glyph04410	MATHEMATICAL SANS-SERIF BOLD CAPITAL ALPHA
        chars.append(0x1D757)  # glyph04411	MATHEMATICAL SANS-SERIF BOLD CAPITAL BETA
        chars.append(
            0x1D758
        )  # glyph04412	MATHEMATICAL SANS-SERIF BOLD CAPITAL GAMMA
        chars.append(
            0x1D759
        )  # glyph04413	MATHEMATICAL SANS-SERIF BOLD CAPITAL DELTA
        chars.append(
            0x1D75A
        )  # glyph04414	MATHEMATICAL SANS-SERIF BOLD CAPITAL EPSILON
        chars.append(0x1D75B)  # glyph04415	MATHEMATICAL SANS-SERIF BOLD CAPITAL ZETA
        chars.append(0xA701)  # uniA701	MODIFIER LETTER CHINESE TONE YANG PING
        chars.append(
            0x1D75D
        )  # glyph04417	MATHEMATICAL SANS-SERIF BOLD CAPITAL THETA
        chars.append(0x1D75E)  # glyph04418	MATHEMATICAL SANS-SERIF BOLD CAPITAL IOTA
        chars.append(
            0x1D75F
        )  # glyph04419	MATHEMATICAL SANS-SERIF BOLD CAPITAL KAPPA
        chars.append(
            0x1D760
        )  # glyph04420	MATHEMATICAL SANS-SERIF BOLD CAPITAL LAMDA
        ...
        chars.append(
            0x1D764
        )  # glyph04424	MATHEMATICAL SANS-SERIF BOLD CAPITAL OMICRON
        ...
        chars.append(
            0x1D767
        )  # glyph04427	MATHEMATICAL SANS-SERIF BOLD CAPITAL THETA SYMBOL
        chars.append(
            0x1D768
        )  # glyph04428	MATHEMATICAL SANS-SERIF BOLD CAPITAL SIGMA
        ...
        chars.append(
            0x1D76E
        )  # glyph04434	MATHEMATICAL SANS-SERIF BOLD CAPITAL OMEGA
        ...
        chars.append(
            0x1D774
        )  # glyph04440	MATHEMATICAL SANS-SERIF BOLD SMALL EPSILON
        ...
        chars.append(
            0x1D77E
        )  # glyph04450	MATHEMATICAL SANS-SERIF BOLD SMALL OMICRON
        ...
        chars.append(
            0x1D781
        )  # glyph04453	MATHEMATICAL SANS-SERIF BOLD SMALL FINAL SIGMA
        ...
        chars.append(
            0x1D784
        )  # glyph04456	MATHEMATICAL SANS-SERIF BOLD SMALL UPSILON
        ...
        chars.append(
            0x1D789
        )  # glyph04461	MATHEMATICAL SANS-SERIF BOLD PARTIAL DIFFERENTIAL
        chars.append(
            0x1D78A
        )  # glyph04462	MATHEMATICAL SANS-SERIF BOLD EPSILON SYMBOL
        ...
        chars.append(
            0x1D790
        )  # glyph04468	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ALPHA
        chars.append(
            0x1D791
        )  # glyph04469	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL BETA
        chars.append(
            0x1D792
        )  # glyph04470	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL GAMMA
        chars.append(
            0x1D793
        )  # glyph04471	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL DELTA
        chars.append(
            0x1D794
        )  # glyph04472	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL EPSILON
        chars.append(
            0x1D795
        )  # glyph04473	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ZETA
        chars.append(
            0x1D796
        )  # glyph04474	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL ETA
        chars.append(
            0x1D797
        )  # glyph04475	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL THETA
        chars.append(0xA703)  # uniA703	MODIFIER LETTER CHINESE TONE YANG SHANG
        chars.append(
            0x1D799
        )  # glyph04477	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL KAPPA
        chars.append(
            0x1D79A
        )  # glyph04478	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL LAMDA
        chars.append(
            0x1D79B
        )  # glyph04479	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL MU
        chars.append(
            0x1D79C
        )  # glyph04480	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL NU
        chars.append(
            0x1D79D
        )  # glyph04481	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL XI
        chars.append(
            0x1D79E
        )  # glyph04482	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL OMICRON
        chars.append(
            0x1D79F
        )  # glyph04483	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL PI
        chars.append(
            0x1D7A0
        )  # glyph04484	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL RHO
        chars.append(
            0x1D7A1
        )  # glyph04485	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL THETA SYMBOL
        chars.append(
            0x1D7A2
        )  # glyph04486	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL SIGMA
        chars.append(
            0x1D7A3
        )  # glyph04487	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL TAU
        chars.append(
            0x1D7A4
        )  # glyph04488	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL UPSILON
        chars.append(
            0x1D7A5
        )  # glyph04489	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL PHI
        chars.append(0x10196)  # glyph02889	ROMAN DENARIUS SIGN
        chars.append(
            0x1D7A7
        )  # glyph04491	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL PSI
        chars.append(
            0x1D7A8
        )  # glyph04492	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL OMEGA
        chars.append(0x1D7A9)  # glyph04493	MATHEMATICAL SANS-SERIF BOLD ITALIC NABLA
        chars.append(
            0x1D7AA
        )  # glyph04494	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL ALPHA
        chars.append(
            0x1D7AB
        )  # glyph04495	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL BETA
        chars.append(
            0x1D7AC
        )  # glyph04496	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL GAMMA
        chars.append(
            0x1D7AD
        )  # glyph04497	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL DELTA
        chars.append(
            0x1D7AE
        )  # glyph04498	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL EPSILON
        chars.append(
            0x1D7AF
        )  # glyph04499	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL ZETA
        chars.append(
            0x1D7B0
        )  # glyph04500	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL ETA
        chars.append(
            0x1D7B1
        )  # glyph04501	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL THETA
        chars.append(
            0x1D7B2
        )  # glyph04502	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL IOTA
        chars.append(
            0x1D7B3
        )  # glyph04503	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL KAPPA
        chars.append(
            0x1D7B4
        )  # glyph04504	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL LAMDA
        chars.append(
            0x1D7B5
        )  # glyph04505	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL MU
        chars.append(0xA704)  # uniA704	MODIFIER LETTER CHINESE TONE YIN QU
        chars.append(
            0x1D7B7
        )  # glyph04507	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL XI
        chars.append(
            0x1D7B8
        )  # glyph04508	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL OMICRON
        chars.append(
            0x1D7B9
        )  # glyph04509	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL PI
        chars.append(
            0x1D7BA
        )  # glyph04510	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL RHO
        chars.append(
            0x1D7BB
        )  # glyph04511	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL FINAL SIGMA
        chars.append(
            0x1D7BC
        )  # glyph04512	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL SIGMA
        chars.append(
            0x1D7BD
        )  # glyph04513	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL TAU
        chars.append(0x1012B)  # glyph02790	AEGEAN NUMBER TEN THOUSAND
        chars.append(
            0x1D7BF
        )  # glyph04515	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL PHI
        chars.append(
            0x1D7C0
        )  # glyph04516	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL CHI
        chars.append(
            0x1D7C1
        )  # glyph04517	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL PSI
        chars.append(
            0x1D7C2
        )  # glyph04518	MATHEMATICAL SANS-SERIF BOLD ITALIC SMALL OMEGA
        chars.append(
            0x1D7C3
        )  # glyph04519	MATHEMATICAL SANS-SERIF BOLD ITALIC PARTIAL DIFFERENTIAL
        chars.append(0x10197)  # glyph02890	ROMAN QUINARIUS SIGN
        chars.append(
            0x1D7C5
        )  # glyph04521	MATHEMATICAL SANS-SERIF BOLD ITALIC THETA SYMBOL
        chars.append(
            0x1D7C6
        )  # glyph04522	MATHEMATICAL SANS-SERIF BOLD ITALIC KAPPA SYMBOL
        chars.append(
            0x1D7C7
        )  # glyph04523	MATHEMATICAL SANS-SERIF BOLD ITALIC PHI SYMBOL
        chars.append(
            0x1D7C8
        )  # glyph04524	MATHEMATICAL SANS-SERIF BOLD ITALIC RHO SYMBOL
        chars.append(
            0x1D7C9
        )  # glyph04525	MATHEMATICAL SANS-SERIF BOLD ITALIC PI SYMBOL
        ...
        chars.append(
            0x1D7A6
        )  # glyph04490	MATHEMATICAL SANS-SERIF BOLD ITALIC CAPITAL CHI
        ...
        chars.append(
            0x1F18A
        )  # glyph04909	CROSSED NEGATIVE SQUARED LATIN CAPITAL LETTER P
