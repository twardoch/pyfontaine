class Charset:
    ...
    def glyphs(self):
        ...
        chars.append(
            0x1EA4
        )  # uni1EA4	LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND ACUTE
        chars.append(
            0x1EA5
        )  # uni1EA5	LATIN SMALL LETTER A WITH CIRCUMFLEX AND ACUTE
        chars.append(
            0x1EA6
        )  # uni1EA6	LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND GRAVE
        chars.append(
            0x1EA7
        )  # uni1EA7	LATIN SMALL LETTER A WITH CIRCUMFLEX AND GRAVE
        chars.append(
            0x1EA8
        )  # uni1EA8	LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND HOOK ABOVE
        chars.append(
            0x1EA9
        )  # uni1EA9	LATIN SMALL LETTER A WITH CIRCUMFLEX AND HOOK ABOVE
        chars.append(
            0x1EAA
        )  # uni1EAA	LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND TILDE
        chars.append(
            0x1EAB
        )  # uni1EAB	LATIN SMALL LETTER A WITH CIRCUMFLEX AND TILDE
        chars.append(
            0x1EAC
        )  # uni1EAC	LATIN CAPITAL LETTER A WITH CIRCUMFLEX AND DOT BELOW
        chars.append(
            0x1EAD
        )  # uni1EAD	LATIN SMALL LETTER A WITH CIRCUMFLEX AND DOT BELOW
        ...
        chars.append(
            0x1EB2
        )  # uni1EB2	LATIN CAPITAL LETTER A WITH BREVE AND HOOK ABOVE
        chars.append(
            0x1EB3
        )  # uni1EB3	LATIN SMALL LETTER A WITH BREVE AND HOOK ABOVE
        ...
        chars.append(
            0x1EB6
        )  # uni1EB6	LATIN CAPITAL LETTER A WITH BREVE AND DOT BELOW
        ...
        chars.append(
            0x1EBE
        )  # uni1EBE	LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND ACUTE
        chars.append(
            0x1EBF
        )  # uni1EBF	LATIN SMALL LETTER E WITH CIRCUMFLEX AND ACUTE
        chars.append(
            0x1EC0
        )  # uni1EC0	LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND GRAVE
        chars.append(
            0x1EC1
        )  # uni1EC1	LATIN SMALL LETTER E WITH CIRCUMFLEX AND GRAVE
        chars.append(
            0x1EC2
        )  # uni1EC2	LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND HOOK ABOVE
        chars.append(
            0x1EC3
        )  # uni1EC3	LATIN SMALL LETTER E WITH CIRCUMFLEX AND HOOK ABOVE
        chars.append(
            0x1EC4
        )  # uni1EC4	LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND TILDE
        chars.append(
            0x1EC5
        )  # uni1EC5	LATIN SMALL LETTER E WITH CIRCUMFLEX AND TILDE
        chars.append(
            0x1EC6
        )  # uni1EC6	LATIN CAPITAL LETTER E WITH CIRCUMFLEX AND DOT BELOW
        chars.append(
            0x1EC7
        )  # uni1EC7	LATIN SMALL LETTER E WITH CIRCUMFLEX AND DOT BELOW
        ...
        chars.append(
            0x1ED0
        )  # uni1ED0	LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND ACUTE
        chars.append(
            0x1ED1
        )  # uni1ED1	LATIN SMALL LETTER O WITH CIRCUMFLEX AND ACUTE
        chars.append(
            0x1ED2
        )  # uni1ED2	LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND GRAVE
        chars.append(
            0x1ED3
        )  # uni1ED3	LATIN SMALL LETTER O WITH CIRCUMFLEX AND GRAVE
        chars.append(
            0x1ED4
        )  # uni1ED4	LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND HOOK ABOVE
        chars.append(
            0x1ED5
        )  # uni1ED5	LATIN SMALL LETTER O WITH CIRCUMFLEX AND HOOK ABOVE
        chars.append(
            0x1ED6
        )  # uni1ED6	LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND TILDE
        chars.append(
            0x1ED7
        )  # uni1ED7	LATIN SMALL LETTER O WITH CIRCUMFLEX AND TILDE
        chars.append(
            0x1ED8
        )  # uni1ED8	LATIN CAPITAL LETTER O WITH CIRCUMFLEX AND DOT BELOW
        chars.append(
            0x1ED9
        )  # uni1ED9	LATIN SMALL LETTER O WITH CIRCUMFLEX AND DOT BELOW
        ...
        chars.append(
            0x1EDE
        )  # uni1EDE	LATIN CAPITAL LETTER O WITH HORN AND HOOK ABOVE
        ...
        chars.append(
            0x1EE2
        )  # uni1EE2	LATIN CAPITAL LETTER O WITH HORN AND DOT BELOW
        ...
        chars.append(
            0x1EEC
        )  # uni1EEC	LATIN CAPITAL LETTER U WITH HORN AND HOOK ABOVE
        ...
        chars.append(
            0x1EF0
        )  # uni1EF0	LATIN CAPITAL LETTER U WITH HORN AND DOT BELOW
